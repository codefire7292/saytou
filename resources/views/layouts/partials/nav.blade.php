...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-dark bg-dark">
  <a class="navbar-brand" href="{{ route('home_path') }}"><span class="fa fa-home"></span> 
Acceuil</a>
...
About <span class="sr-only">(current)</span></a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route('etudiant_path') }}"><span class="fa fa-user"></span> Etudiants</a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="{{ route('users_path') }}"><i class="fa fa-list"></i> Lister</a>
          <a class="dropdown-item" href="{{ route('users.create_path') }}"><i class="fa fa-user-plus"></i> Ajouter</a>
        </div>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="{{ route('enquete_path') }}"><i class="fa fa-list"></i> Lister</a>
          <a class="dropdown-item" href="{{ route('enquete.create_path') }}"><i class="fa fa-folder"></i> Ajouter</a>
        </div>
      </li>
      <li class="nav-item">
