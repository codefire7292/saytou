...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-dark bg-dark">
  <a class="navbar-brand" href="{{ route('admin_index') }}"><span class="fa fa-home"></span> 
Acceuil</a>
...
About <span class="sr-only">(current)</span></a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="{{ route('enquete.index') }}"><i class="fa fa-list"></i> Lister</a>
          <a class="dropdown-item" href="{{ route('enquete.create') }}"><i class="fa fa-folder"></i> Ajouter</a>
        </div>
      </li>
      <li class="nav-item">
