			...
			<form method="POST" action="{{ route('user.update',$user) }}">
			  ...
			  <div class="form-row">	
				  ...
				  <div class="form-group col-md-6">
				    ...
				    <input type="date" name="date_naissence" class="form-control" id="inputDate2" placeholder="02/09/2019" value="{{ old('date_naissance')?? $user->date_naissance }}">
				  </div>
			  </div>
			  <div class="form-row">
			    ...
			    <div class="form-group col-md-4">
			      ...
			      <select id="inputState" name="role" class="form-control">
				    ...
				    @elseif(Auth::user()->role === 'coordonnateur' ) 
			        	<option {{ $user->role?'selected':'' }} value="enquéteur">Enquéteur</option>
			        @endif
			      </select>
			    </div>
			    <div class="form-group col-md-4">
