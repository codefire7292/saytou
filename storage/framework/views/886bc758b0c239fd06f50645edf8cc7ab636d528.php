   <!-- Left Panel -->
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(route('admin_index')); ?>"><img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo"></a>
                <a class="navbar-brand hidden" href="<?php echo e(route('admin_index')); ?>"><img src="<?php echo e(asset('images/logo2.png')); ?>" alt="Logo"></a>
            </div>

            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="<?php echo e(route('admin_index')); ?>"> <i class="menu-icon fa fa-dashboard"></i>Dashboard</a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-list"></i><a href="<?php echo e(route('user.index')); ?>">Liste(s)</a></li>
                            <li><i class="fa fa-user-plus"></i><a href="<?php echo e(route('user.create')); ?>">Ajout</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-list"></i><a href="<?php echo e(route('etudiant.index')); ?>">Liste</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon ti-list-ol"></i><a href="<?php echo e(route('enquete.index')); ?>">Liste</a></li>
                            <li><i class="menu-icon fa fa-cog fa-spin fa-3x"></i><a href="<?php echo e(route('enquete.create')); ?>">Créer</a></li>
                            <li><i class="menu-icon fa fa-street-view"></i><a href="maps-vector.html">Affectation</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon ti-world"></i><a href="<?php echo e(route('zone.index')); ?>">Lister zone</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                      ...
                      <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="menu-icon fa fa-sign-in"></i><a href="<?php echo e(route('user.update', Auth::user()->id)); ?>">Update</a></li>
                        <li><i class="menu-icon fa fa-paper-plane"></i><a href="<?php echo e(route('user.create')); ?>">Forget Pass</a></li>
                      </ul>
                      <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('help_path')); ?>"><i class="menu-icon fa fa-life-ring"></i> Help</a>
                      </li>
                      <li class="nav-item active">
                        <a class="nav-link" href="<?php echo e(route('about_path')); ?>"><span class="menu-icon fa fa-book"></span> About <span class="sr-only">(current)</span></a>
                      </li>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="<?php echo e($file); ?>" alt="User Avatar">
                        </a>

                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="<?php echo e(route('profile_path')); ?>"><i class="fa fa-user"></i> Mon Profil</a>
        ...
        <!-- Header-->
<?php /**PATH /root/saytou/resources/views/layouts/partials/nav_admin.blade.php ENDPATH**/ ?>