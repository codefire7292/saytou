      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
            <a class="dropdown-item" href="<?php echo e(route('user.index')); ?>"><?php echo e(__('Profile')); ?></a>
...
<?php /**PATH /root/saytou/resources/views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>