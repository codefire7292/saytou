...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-dark bg-dark">
  <a class="navbar-brand" href="<?php echo e(route('patron_index')); ?>"><span class="fa fa-home"></span> 
Acceuil</a>
...
About <span class="sr-only">(current)</span></a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('etudiant.index')); ?>"><span class="fa fa-user"></span> Etudiants</a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="<?php echo e(route('enquete.index')); ?>"><i class="fa fa-list"></i> Lister</a>
        </div>
      </li>
      <li class="nav-item">
...
</nav><?php /**PATH /root/saytou/resources/views/layouts/partials/nav_patron.blade.php ENDPATH**/ ?>