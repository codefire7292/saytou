      ...
      <div class="card-body">
        ...
        <p> 
            <table class="table table-hover">
              ...
              <tbody>
                <?php $__currentLoopData = $enquete; $i = 0; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enquete): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
      ...
      <div class="card-body">
        ...
        <p>
            <table class="table table-hover"> 
              ...
              <tbody>
                <?php $__currentLoopData = $users; $i=0; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <th scope="row"><?php echo e(++$i); ?></th>
      ...
      <div class="card-body">
        ...
        <p>
            <table class="table table-hover"> 
              ...
              <tbody>
                <?php $__currentLoopData = $zones; $i=0; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <th scope="row"><?php echo e(++$i); ?></th>
                      <td><?php echo e($zone->nom_zone); ?></td>
                      <td><?php echo e($zone->departement); ?></td>
                      <td><?php echo e($zone->region); ?></td>
                      <td><?php echo e($zone->nom); ?> <?php echo e($zone->prenom); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
            </table>
      ...
      <div class="card-body">
        ...
        <p>
           <table class="table table-hover"> 
              ...
              <tbody>
                <?php $__currentLoopData = $enqueter; $i=0; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <th scope="row"><?php echo e(++$i); ?></th>
                      <td><?php echo e($user->nom); ?></td>
                      <td><?php echo e($user->prenom); ?></td>
